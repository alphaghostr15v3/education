...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.events.index') }}" class="btn btn-outline-secondary btn-sm me-3">
                <i class="bi bi-arrow-left"></i>
            </a>
            <div>
                <h2 class="fw-bold h4 mb-0">Create Event</h2>
                <p class="text-muted small">Schedule a new workshop or webinar.</p>
            </div>
        </div>
    </div>
</div>
