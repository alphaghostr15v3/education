...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="fw-bold h4 mb-0">Create Case Study</h2>
                <p class="text-muted small">Share a detailed success story.</p>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="challenge" rows="4" class="form-control">{{ old('challenge') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">The Solution</label>
                                        <textarea name="solution" rows="4" class="form-control">{{ old('solution') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">The Result</label>
                                        <textarea name="result" rows="4" class="form-control">{{ old('result') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
