        ...
        @forelse($events as $event)
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 overflow-hidden hover-lift">
                    @if($event->image_path)
                        <img src="{{ asset($event->image_path) }}" class="card-img-top" alt="{{ $event->title }}" style="height: 200px; object-fit: cover;">
                    @else
                    ...
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small mb-4">{{ Str::limit($event->description, 120) }}</p>
